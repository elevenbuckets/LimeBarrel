...
const allConditions = _extends({}, web3EthSanity, web3EthFulfill);
const fs = require('fs');
...
class Wrap3 {
        ...
        */
        constructor(cfpath) {
                ...
                this.unlockAndSign = passwd => (addr, message = null) => {
                ...
                this.connectRPC = () => {
                        const __connectRPC = (resolve, reject) => {
                                try {
                                        if (this.web3 instanceof Web3 && this.web3.net._requestManager.provider instanceof Web3.providers.HttpProvider) {
                ...
                this.connectIPC = () => {
                        const __connectIPC = (resolve, reject) => {
                                try {
                                        if (this.ipc3 instanceof Web3 && this.ipc3.net._requestManager.provider instanceof Web3.providers.IpcProvider) {
                                                resolve(true);
                ...
                this.byte32ToAddress = b => {
                        return this.web3.toAddress(this.web3.toHex(this.web3.toBigNumber(String(b))));
                };

                this.byte32ToDecimal = b => {
                        return this.web3.toDecimal(this.web3.toBigNumber(String(b)));
                };

                this.byte32ToBigNumber = b => {
                        return this.web3.toBigNumber(String(b));
                };
